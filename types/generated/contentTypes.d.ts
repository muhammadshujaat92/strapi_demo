...
export interface ApiContactUsContactUs extends Schema.CollectionType {
  ...
  attributes: {
    contactPageBox: Attribute.Component<'contact-page.contact', true>;
    bannerHeading: Attribute.String;
...
export interface ApiHomePageHomePage extends Schema.CollectionType {
  ...
  attributes: {
    slides: Attribute.Component<'slides.header-slides', true>;
    section1: Attribute.Component<'section1.section1'>;
    section2: Attribute.Component<'section2.section2'>;
    section3: Attribute.Component<'section2.section2'>;
    section4: Attribute.Component<'section4.section4'>;
    section5: Attribute.Component<'section5.section5'>;
    testimonialBox: Attribute.Component<'hometestimonial.home-testimonials'>;
    faqSection: Attribute.Component<'faq-section.faq-section'>;
    lastSectionData: Attribute.Component<'lastsection.last-section'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
